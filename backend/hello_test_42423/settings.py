"""
Django settings for hello_test_42423 project.
...
ROOT_URLCONF = 'hello_test_42423.urls'
...
WSGI_APPLICATION = 'hello_test_42423.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_test_42423 API",
    "DESCRIPTION": "API documentation for hello_test_42423 App",
    "VERSION": "v1",
}
